...
import 'package:happi_workers_client/Practitioners/pract_sessions.dart';
import 'package:happi_workers_client/ProfileCustom/profile_custom7.dart';
import 'package:happi_workers_client/constants.dart';


class PractitionerDetails extends StatefulWidget {
  const PractitionerDetails({super.key});

  @override
  State<PractitionerDetails> createState() => _PractitionerDetailsState();
}

class _PractitionerDetailsState extends State<PractitionerDetails> {
